...
def action_status(root=None) -> int:
    ...
    payload = {
        ...
        # IS IT WORKING, or merely running? IDLE / BUSY are healthy; STALLED and
        # DEAD are not. A long collection pass that keeps advancing is BUSY.
        ...
        "progress_stall_after_seconds": ic.PROGRESS_STALL_SECONDS,
        "heartbeat_stale_after_seconds": ic.HEARTBEAT_STALE_SECONDS,
