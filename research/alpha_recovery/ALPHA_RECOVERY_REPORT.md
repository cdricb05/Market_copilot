...
- package: `alpha_agent/alpha_recovery/` (checkpoint, scoreboard, forecast_contract, incumbent, program, earnings_events, news, tournament, cadence, market_direction, equity_challengers, frontier_residual, forecast_products, forward_package, purchase_case, report)
